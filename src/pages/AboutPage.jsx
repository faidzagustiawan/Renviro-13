...
const partners = [
  { src: '/ascend.png', alt: 'Partner 1' },
  { src: '/tiktok.png', alt: 'Partner 2' },
  { src: '/barbie.png', alt: 'Partner 3' },
  { src: '/chanel.png', alt: 'Partner 4' },
  { src: '/kia.png', alt: 'Partner 5' },
  { src: '/IKN.png', alt: 'Partner 6' },
]
const AboutPage = () => {
  return (
    <div className="pt-20 pb-16">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3">
                  <a href="#" className="text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-accent-400">
      ...
      {/* Mitra Kami */}
      <section className="py-16 bg-primary-50 dark:bg-primary-900/20 overflow-hidden">
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
